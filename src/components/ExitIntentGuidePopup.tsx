          ...
          >
            <div className="flex justify-between items-start mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <span className={`text-[10px] font-mono font-medium tracking-wider ${guide.accent.badgeText} uppercase`}>
                    Zanim pójdziesz — to jest bezpłatne
                  </span>
              ...
              <button
                onClick={() => setVisible(false)}
                aria-label="Zamknij"
                className="p-1 text-gray-400 hover:bg-gray-100 rounded-lg cursor-pointer shrink-0"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <a
                ...
                className={`flex-1 ${guide.accent.button} ${guide.accent.buttonHover} text-white font-sans font-bold px-5 py-3 rounded-xl text-sm shadow-md transition-all flex items-center justify-center gap-2 cursor-pointer`}
              >
              ...
              <a
                ...
                className="flex-1 bg-[#0B1F3A] hover:bg-black text-white font-sans font-bold px-5 py-3 rounded-xl text-sm shadow-md transition-all flex items-center justify-center gap-2 cursor-pointer"
              >
            ...
            <p className="text-[11px] text-gray-400 text-center pt-3">
              100% bezpłatnie, bez zobowiązań &middot; 07491 978400
            </p>
